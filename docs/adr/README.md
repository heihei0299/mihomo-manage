...
This page is the navigation index for the repository's architecture decisions. Read the linked ADR for the full rationale and consequences. Current maintenance boundaries are defined by `docs/maintainability.md`.

| ADR | Topic | Status |
| --- | --- | --- |
| [0001](./0001-simple-string-template.md) | Simple string template | Superseded by ADR-0008 |
